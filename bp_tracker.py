...
DEFAULT_LOCATIONS = [
    {"name": "Yongbyon Nuclear Complex", "status": "activity", "note": "Jan 2026: 5 MWe reactor and IRT-2000 research reactor both operating. Thermal cladding discovered on centrifuge enrichment facility roof (first observed late 2025). Suspected new enrichment building under construction nearby.", "last_source_date": "2026-01", "direction": "up"},
    {"name": "Sinpo South Shipyard", "status": "activity", "note": "Feb 2025: Hero Kim Kun Ok SLBM submarine exited drydock after 2+ years of fitting-out but still not operational as of May 2025. New submarine construction begun in separate bay.", "last_source_date": "2025-05", "direction": "up"},
    ...
    {"name": "Sohae Satellite Launch Station", "status": "activity", "note": "Sep-Oct 2025: Small engine test detected at Sohae vertical engine test stand. New seaport facility and large assembly building construction progressing on site.", "last_source_date": "2025-10", "direction": "up"},
    ...
    {"name": "Tumangang–Khasan (NK-Russia border)", "status": "activity", "note": "2025-2026: New road bridge under construction at Tumangang-Khasan crossing (target completion Dec 2026). Passenger rail service resumed mid-2025. Ore and tank car traffic increasing.", "last_source_date": "2026-01", "direction": "up"},
