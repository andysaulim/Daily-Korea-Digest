...
| Metric | Value |
|--------|-------|
| Last generated | September 3, 2026 at 7:10 AM ET |
| Digest date | Thursday, September 3, 2026 |
| Articles collected | 188 |
| Unique sources | 33 |
| Top stories | 3 |
| Overnight items | 6 |
| Word count | ~1,534 |
| Kim Jong Un appeared | No |
| Est. API cost (this run) | $0.55 |
| Est. API cost (month to date) | $1.56 (3 runs) |
