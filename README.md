...
| Metric | Value |
|--------|-------|
| Last generated | August 5, 2026 at 7:06 AM ET |
| Digest date | Wednesday, August 5, 2026 |
| Articles collected | 194 |
| Unique sources | 35 |
| Top stories | 4 |
| Overnight items | 4 |
| Word count | ~1,323 |
| Kim Jong Un appeared | No |
| Est. API cost (this run) | $0.39 |
| Est. API cost (month to date) | $1.97 (5 runs) |
