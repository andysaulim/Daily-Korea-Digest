...
| Metric | Value |
|--------|-------|
| Last generated | August 11, 2026 at 7:08 AM ET |
| Digest date | Tuesday, August 11, 2026 |
| Articles collected | 160 |
| Unique sources | 31 |
| Top stories | 3 |
| Overnight items | 3 |
| Word count | ~1,267 |
| Kim Jong Un appeared | No |
| Est. API cost (this run) | $0.50 |
| Est. API cost (month to date) | $6.12 (11 runs) |
