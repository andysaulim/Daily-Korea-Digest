...
| Metric | Value |
|--------|-------|
| Last generated | August 31, 2026 at 7:15 AM ET |
| Digest date | Monday, August 31, 2026 |
| Articles collected | 168 |
| Unique sources | 34 |
| Top stories | 3 |
| Overnight items | 4 |
| Word count | ~1,202 |
| Kim Jong Un appeared | No |
| Est. API cost (this run) | $0.94 |
| Est. API cost (month to date) | $17.78 (31 runs) |
