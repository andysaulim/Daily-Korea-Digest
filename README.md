...
| Metric | Value |
|--------|-------|
| Last generated | July 21, 2026 at 7:08 AM ET |
| Digest date | Tuesday, July 21, 2026 |
| Articles collected | 169 |
| Unique sources | 32 |
| Top stories | 3 |
| Overnight items | 5 |
| Word count | ~1,463 |
| Kim Jong Un appeared | No |
| Est. API cost (this run) | $0.47 |
| Est. API cost (month to date) | $5.33 (13 runs) |
