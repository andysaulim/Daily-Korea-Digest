...
| Metric | Value |
|--------|-------|
| Last generated | March 25, 2026 at 7:45 AM ET |
| Digest date | Wednesday, March 25, 2026 |
| Articles collected | 162 |
| Unique sources | 29 |
| Top stories | 3 |
| Overnight items | 4 |
| Word count | ~1,217 |
...
140+ RSS feeds  -->  Claude Sonnet  -->  HTML email  -->  Gmail SMTP
  + market data       + CSIS databases    + archive        + GitHub Pages
  + sentiment          (NK-Russia,         (public/)
  + KCNA                provocations)
```
...
3. **Digest** -- Claude Sonnet processes all articles with an expert system prompt, producing a structured JSON briefing (target 1,200-1,400 words)
4. **Validate** -- Pre-send quality gate checks word count, source diversity, duplicates, prestige outlet inclusion, and data integrity
...
**Prestige outlet rule:** Korea stories from WSJ, NYT, Washington Post, Bloomberg, Financial Times, and The Economist are always included.
...
| Beyond Parallel | 8 monitored DPRK facility locations with status tracking |
...
- **Prestige outlets**: WSJ/NYT/WaPo/Bloomberg/FT/Economist stories never dropped
