...
| Metric | Value |
|--------|-------|
| Last generated | September 22, 2026 at 7:08 AM ET |
| Digest date | Tuesday, September 22, 2026 |
| Articles collected | 837 |
| Unique sources | 56 |
| Top stories | 4 |
| Overnight items | 5 |
| Word count | ~1,456 |
| Kim Jong Un appeared | Yes |
| Est. API cost (this run) | $0.65 |
| Est. API cost (month to date) | $14.95 (18 runs) |
