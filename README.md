...
| Metric | Value |
|--------|-------|
| Last generated | August 14, 2026 at 7:09 AM ET |
| Digest date | Friday, August 14, 2026 |
| Articles collected | 173 |
| Unique sources | 37 |
| Top stories | 3 |
| Overnight items | 5 |
| Word count | ~1,363 |
| Kim Jong Un appeared | No |
| Est. API cost (this run) | $0.72 |
| Est. API cost (month to date) | $7.70 (14 runs) |
