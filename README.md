...
| Metric | Value |
|--------|-------|
| Last generated | August 20, 2026 at 7:09 AM ET |
| Digest date | Thursday, August 20, 2026 |
| Articles collected | 265 |
| Unique sources | 52 |
| Top stories | 3 |
| Overnight items | 5 |
| Word count | ~1,342 |
| Kim Jong Un appeared | No |
| Est. API cost (this run) | $0.51 |
| Est. API cost (month to date) | $10.47 (20 runs) |
