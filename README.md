...
| Metric | Value |
|--------|-------|
| Last generated | July 11, 2026 at 7:08 AM ET |
| Digest date | Saturday, July 11, 2026 |
| Articles collected | 113 |
| Unique sources | 26 |
| Top stories | 3 |
| Overnight items | 5 |
| Word count | ~1,589 |
| Kim Jong Un appeared | Yes |
| Est. API cost (this run) | $0.45 |
| Est. API cost (month to date) | $1.23 (3 runs) |
