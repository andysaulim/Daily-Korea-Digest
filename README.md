...
| Metric | Value |
|--------|-------|
| Last generated | September 16, 2026 at 7:08 AM ET |
| Digest date | Wednesday, September 16, 2026 |
| Articles collected | 815 |
| Unique sources | 44 |
| Top stories | 3 |
| Overnight items | 6 |
| Word count | ~923 |
| Kim Jong Un appeared | No |
| Est. API cost (this run) | $0.67 |
| Est. API cost (month to date) | $10.05 (12 runs) |
