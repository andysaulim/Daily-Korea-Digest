...
| Metric | Value |
|--------|-------|
| Last generated | September 21, 2026 at 7:07 AM ET |
| Digest date | Monday, September 21, 2026 |
| Articles collected | 829 |
| Unique sources | 45 |
| Top stories | 3 |
| Overnight items | 8 |
| Word count | ~1,052 |
| Kim Jong Un appeared | No |
| Est. API cost (this run) | $0.77 |
| Est. API cost (month to date) | $14.31 (17 runs) |
