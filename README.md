...
| Metric | Value |
|--------|-------|
| Last generated | August 21, 2026 at 7:13 AM ET |
| Digest date | Friday, August 21, 2026 |
| Articles collected | 211 |
| Unique sources | 45 |
| Top stories | 3 |
| Overnight items | 5 |
| Word count | ~1,349 |
| Kim Jong Un appeared | No |
| Est. API cost (this run) | $0.95 |
| Est. API cost (month to date) | $11.42 (21 runs) |
