...
| Metric | Value |
|--------|-------|
| Last generated | August 12, 2026 at 7:06 AM ET |
| Digest date | Wednesday, August 12, 2026 |
| Articles collected | 221 |
| Unique sources | 41 |
| Top stories | 3 |
| Overnight items | 5 |
| Word count | ~1,257 |
| Kim Jong Un appeared | No |
| Est. API cost (this run) | $0.43 |
| Est. API cost (month to date) | $6.55 (12 runs) |
