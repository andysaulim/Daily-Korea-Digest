...
| Metric | Value |
|--------|-------|
| Last generated | August 13, 2026 at 7:06 AM ET |
| Digest date | Thursday, August 13, 2026 |
| Articles collected | 171 |
| Unique sources | 35 |
| Top stories | 4 |
| Overnight items | 6 |
| Word count | ~1,531 |
| Kim Jong Un appeared | No |
| Est. API cost (this run) | $0.44 |
| Est. API cost (month to date) | $6.98 (13 runs) |
