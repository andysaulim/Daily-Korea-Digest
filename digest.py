...
- calendar_watch: upcoming events relevant to Korea policy in the next 14-30 days. 0-5 items; there is NO minimum. An empty array is correct when nothing verifiable is upcoming, and is always better than filling the section.
