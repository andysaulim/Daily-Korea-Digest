...
- public_sentiment: standing dashboard of Korean public opinion polling — all from Gallup Korea weekly survey unless noted. Object with:
  ...
  - consumer_confidence: object with value (CSI index number as string, e.g. "98"), source ("Bank of Korea"), last_updated. The BOK Consumer Sentiment Index (100 = neutral, above = optimistic, below = pessimistic). Updates monthly.
