...
- us_korea_deals: US-Korea trade and investment deals from TODAY's news only. Object with:
  - deals: array of new deals, investments, or trade developments announced today. Track: FDI announcements (Samsung, SK, Hyundai, LG, Hanwha investments in US; US company investments in ROK), trade agreements, defense procurement (KF-21, arms sales, military contracts), energy deals (nuclear, LNG, renewables), tech partnerships (semiconductors, AI, batteries, EVs), supply chain agreements. Flag any deal that is part of the $350B ROK-US investment commitment (Aug 2025 White House summit). Each: url, source, headline, value (deal value if mentioned, e.g. "$2.3B", or null), sector (defense/energy/tech/manufacturing/trade/tariff), parties (who is involved, 1 line), detail (1 sentence on significance), is_350b_commitment (boolean — true if this deal counts toward the $350B pledge). Empty array if no deals today. Only include the deals array — no status_tracker, no investment_package, no tariff_snapshot.
