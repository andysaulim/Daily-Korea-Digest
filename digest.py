...
- us_korea_deals: US-Korea trade and investment deals from TODAY's news only. Object with:
  ...
  If a deal from today's news updates, expands, or adds to any of these entries, set wh_tracker=true and note it in the detail field.
