...
- overnight_items: 5-7 highest-priority items. Each: url, source, category, headline (under 100 chars), body_text (2-3 sentences — summarize the key facts, then add context or implication. Be substantive — thin one-liners waste the reader's time)
