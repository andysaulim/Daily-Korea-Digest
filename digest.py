...
- us_korea_deals: US-Korea trade and investment tracker from today's news. Object with:
  ...
  - investment_package: running total of ROK's $350B US investment commitment — track cumulative deals announced, remaining pledged, and percentage fulfilled. Object: total_pledged ("$350B"), announced_to_date (cumulative $ from all announced deals), pct_fulfilled (percentage), latest_update (1 sentence). Null if no relevant news today.
