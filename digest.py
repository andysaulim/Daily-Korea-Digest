...
- public_sentiment: standing dashboard of Korean public opinion polling — ALL metrics MUST come from the SAME Gallup Korea weekly poll (same survey date). Do NOT mix dates across metrics. Object with:
  - presidential_approval: object with value (percentage as string, e.g. "61%"), trend (up/down/stable), source (polling firm name, e.g. "Gallup Korea"), last_updated (date string, e.g. "May 12-14, 2026"). IMPORTANT — HARD BASELINE: As of May 3rd week 2026 the latest confirmed Gallup Korea figures are: 61% approval, DP 45%, PPP 23%, independents 27% (surveyed May 12-14). Use these EXACT numbers. Do NOT change ANY polling number unless a TODAY's source article explicitly reports a NEW Gallup Korea weekly poll with different figures AND you can cite the specific article. Changing a polling number without a sourced article is a fabrication. When in doubt, carry forward 61%/45%/23%/27%. Never mix poll dates.
  ...
  - party_opposition: object with value (percentage as string, e.g. "23%"), party (English name, e.g. "People Power Party"), party_kr (Korean name, e.g. "국민의힘"), trend (up/down/stable), source, last_updated. MUST use the same Gallup Korea poll date as presidential_approval.
