...
- on_this_day: 1 historical Korea event that happened on TODAY's calendar date (same month and day). Array with exactly 1 item: date (e.g. "March 23, 2010"), event (1 sentence), relevance (1 sentence connecting to current situation). ONLY use events from the VERIFIED KOREA DATES reference below — do NOT cite historical events from memory, as dates may be wrong. The event MUST match today's exact month and day. If no verified event falls on today's date, check the next 3 days only. If still nothing, return empty array. NEVER pick an event more than 3 days in the future.
...
- us_korea_deals: US-Korea trade and investment deals. Object with four keys. IMPORTANT — NO REPETITION across sub-sections: tariff rates belong ONLY in tariff_tracker (do not repeat rates in trade_policy). Investment totals belong ONLY in investment_package (do not restate in deals). trade_policy covers non-tariff policy actions only. Each fact appears exactly once.
  - investment_package: running status of the ROK-US $350B investment commitment. Object with: total_pledged (string, e.g. "$350B"), announced_to_date (string — USE THE PRE-CALCULATED SUM BELOW, do NOT recalculate), pct_fulfilled (integer 0-100 — USE THE PRE-CALCULATED PERCENTAGE BELOW), latest_update (1 sentence on most recent change), known_deals (array: company, value, sector). IMPORTANT: The sum of known deals is PRE-CALCULATED for you. Use it exactly as given. Only adjust if today's articles announce a NEW deal not already in the list.
  ...
  REFERENCE — White House Investment Tracker ($350B pledge). Timeline: framework agreed Jul 30 2025; Trump-Lee summit Aug 25 2025 (Washington); Trump state visit to Korea Oct 29 2025 (Gyeongju); National Assembly passed Special Investment Act Mar 12 2026 (226-8-8), creating Korea-US Strategic Investment Corporation. Investment structure: $150B shipbuilding, $200B strategic sectors (capped $20B/yr), $100B US energy purchases. Known entries:
    Samsung Electronics: $37B (Semiconductors — Taylor TX 2nm fabs), Hyundai Motor Group: $26B (Manufacturing — Georgia EV, Louisiana steel, robotics), SK Group: $22B (Semiconductors & Batteries — SK Hynix Indiana, SK On Georgia), HD Hyundai / Cerberus Maritime: $5B (Shipbuilding — US shipyard modernization/acquisition partnership), Hanwha Ocean: $5B (Shipbuilding — Philly Shipyard expansion, Aug 2025), LS Cable & System: $1.4B (Manufacturing — Chesapeake VA copper rod + LS GreenLink submarine cable), Samsung Biologics: $280M (Pharma — GSK Rockville MD acquisition), Paris Baguette: $200M (Food & Beverage — Burleson TX plant), Korean Air: $36.2B (Boeing aircraft purchase — 103 aircraft, Oct 2025 summit), Korean Air / GE Aerospace: $13.7B (Engines + maintenance for Boeing fleet, Oct 2025 summit), POSCO International / ReElement: $900M (Critical Minerals — US rare earth separation/refining), L3Harris / Korean Air: $2.26B (Defense — 4 AEW&C aircraft for ROK).
  *** PRE-CALCULATED TOTAL: $149.9B of $350B pledged (43% fulfilled). Use announced_to_date="$149.9B" and pct_fulfilled=43 EXACTLY. Only change these numbers if today's articles report a NEW deal not already listed above. ***
  NOTE: The $350B framework has three buckets: $150B shipbuilding (MASGA), $200B strategic sectors (capped $20B/yr via Korea-US Strategic Investment Corporation), $100B US energy purchases (KOGAS LNG deals not counted in investment total above). Energy purchase commitments are tracked separately.
