...
- calendar_watch: array of 5 key upcoming events in the next 14-30 days relevant to Korea policy (MAX 5 — pick the most consequential). Keep it straightforward — just the facts. Each: month (3-letter, e.g. "MAR", "APR"), day (integer), headline (short title), detail (1-2 sentences). Prioritize: congressional hearings, bilateral summits, exercise dates, NK anniversaries (Kim Il Sung birthday Apr 15, Party founding Oct 10, etc.), diplomatic deadlines, trade negotiation rounds. No signals, no urgency labels — just the event and when it happens.
...
- also_today: remaining articles score >= 4, INCLUDING Technology/Business/Energy stories. Include generously — more coverage is better than less. Each: url, source, category, headline, body_text (1-2 sentences), color_bar_class (cb-navy=DPRK, cb-red=Security, cb-lt=Policy, cb-mid=Assembly, cb-nkch=NK-Russia-China, cb-tech=Technology/Energy, cb-biz=Business)
